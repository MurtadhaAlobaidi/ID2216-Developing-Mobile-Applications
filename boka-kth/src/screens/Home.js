...
import { View, Text, Button, SafeAreaView, ActivityIndicator, FlatList, TouchableOpacity } from 'react-native';
      ...
      <View style={AppStyles.rowContainer}>
        <View style={HomeStyles.container}>
          <Button
            ...
            color='#000000'
            onPress={() => navigation.navigate("TimeSlotRooms", { roomId: item.roomId, roomDocId: item.id })}
          />
        </View>
      </View>
    );
    ...
    <SafeAreaView style={AppStyles.container}>
      ...
      <View style={AppStyles.container}>
        ...
        <View style={MyBookingsStyles.bookingInfo}>
          <Text style={MyBookingsStyles.bookingInfoText}> Du är inloggad som: {auth.currentUser ? auth.currentUser.email : null}</Text>
        </View>
